...
struct IMGUI_API ImGuiInputTextState
{
    ...
    int                     BufCapacityA;           // TextA buffer capacity
...
//#endif
    ...
    // InputText
    IMGUI_API bool          InputTextEx(ImStrv label, ImStrv hint, char* buf, int* buf_len_p, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
