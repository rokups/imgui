...
public:
    ...
    ImGuiID     GetIDFromPath(const char* path);                // Supports leading '../' to go up in ID stack and '/' to start from top of ID stack. Multiple hashed values are separated with '/', to hash character '/' escape it with '\'.
